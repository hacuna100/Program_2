...
namespace Prog0
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            GroundPackage GroundPackage1 = new GroundPackage(a1, a2, 11, 22, 33, 44);
            NextDayAirPackage NxtDayAirPckge1 = new NextDayAirPackage(a3, a4, 44, 33, 22, 11, 13);
            ...
            parcels.Add(l2);
            parcels.Add(l3);
            parcels.Add(GroundPackage1);
            parcels.Add(NxtDayAirPckge1);
